/**
 * P3 Payroll Module Exports
 * Owner: P3 (Payroll)
 */
export { default as PayrunListPage } from './pages/PayrunListPage';
export { default as PayrunDetailPage } from './pages/PayrunDetailPage';
export { default as SalaryStructuresPage } from './pages/SalaryStructuresPage';
